...
frames = 29.97
time_step = 0.1
path = "/home/ubuntu/Documents/yolov7-object-tracking/runs/detect/object_tracking2/labels/"  # 文件夹的路径
...
data.to_csv(path_or_buf="/media/ubuntu/ANL/" + "Data1.csv", columns=['id', 'time', 'x_pix', 'y_pix', 'w_pix', 'h_pix'], index=False)
